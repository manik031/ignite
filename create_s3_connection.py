...
def create_s3_connection(aws_access_key_id, aws_secret_access_key,region ):
    ...
    return s3
aws_access_key_id = 'AKIAVRUVTIGQZ6JSVSZX'
aws_secret_access_key ='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'
region ='eu-north-1'
s3_client = create_s3_connection(aws_access_key_id, aws_secret_access_key, region)
